...
_.last = function (array, number){
  ...
  } else return array.slice(array.length - number, array.length);
};
/** _.each()
* Arguments:
*   1) A collection
...
_.partition = function(array, func){
    var arr = [];
    arr.push(_.filter(array, func));
    arr.push(_.reject(array, func));
    return arr;
};
...
_.map = function(collection, func){
    ...
    _.each(collection, function(element, index, collection){
        funcArray.push(func(element, index, collection));
    });
    return funcArray;
};
...
_.pluck = function(collection, prop){
   var propArray = [];
    _.map(collection, function(element, index, collection){
        propArray.push(collection[index][prop]);
    });
    return propArray;
};
...
_.contains = function(collection, value){
   return ((_.indexOf(collection, value) > -1)? true : false);
};
...
_.every = function(collection, func) {
    var check = true;
    if (func === undefined) {
        func = function (value, index, collection) {
            if (value) { 
                return true;
            }
        };
